...
for i in range(10):
    take_profit = 0.01 * (i + 1) # for shorting
    ...
    for j in range(10):
        ...
        # print("stop loss set:", stop_loss, "| take profit set: ", take_profit)
        ...
        if(annualized_returns > highest_returns):
            highest_returns = annualized_returns
            stop_loss_hr = stop_loss
            take_profit_hr = take_profit
        
        if(win_rate > highest_win_rate):
            highest_win_rate = win_rate
            stop_loss_wr = stop_loss
            take_profit_wr = take_profit

print("========== FOR HIGHEST RETURNS ==========")
print("best stop loss:", stop_loss_hr, "| best take profit:", take_profit_hr, "| annualized:", highest_returns)
print(" ")
print("========== FOR HIGHEST WIN RATE ==========")
print("best stop loss:", stop_loss_wr, "| best take profit:", take_profit_wr, "| win rate:", highest_win_rate)